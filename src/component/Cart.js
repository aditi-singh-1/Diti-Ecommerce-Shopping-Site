    ...
    <span className="inc" onClick={() => dispatch({type: 'INC', payload: product.id})}><BsPlus/></span>
                         ...
                         <div className="col-2">
                             <div className="cart__total text-center">
                                 <CurrencyFormat value= {product.discountprice * product.quantity} displayType={'text'} thousandSeparator={true} prefix={'₹'} />
                             </div>
                         </div>
                         <div className="col-2">
                    ...
                    <div className="col-7 summary-col">
                    ...
                    <div className="col-8">{totalQuantities}</div>
                                </div>
                                <div className="row mb-10">
                                    <div className="col-8">
                                        Total Price
